...
include_once 'Beans/notification.inc.php';
...
class DB {
	...
	private function __construct() {
		...
		$host = 'postgresql-bitsbee.alwaysdata.net';
		$port = '5432';
		$db   = 'bitsbee_bd';
		$user = 'bitsbee';
		$pwd  = 'majlbc_BitsBee';
	...
	public function getNotificationsRecues($id)
	{
		$requete = "Select * from NOTIFICATIONS where idDest = ?";
		return $this->execQuery($requete,array($id),'Notification');
	}
}
?>
